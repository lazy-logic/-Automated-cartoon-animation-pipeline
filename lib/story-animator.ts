...
import { CharacterRig, CHARACTER_RIGS, getCharacterRig } from './sprite-system';
import { AnimationClip, ANIMATION_PRESETS, getAnimationForAction } from './keyframe-animation';
import { EditableCharacter, EditableScene } from '@/components/InteractiveSceneEditor';
import type { AIGeneratedScene } from './ai-types';
