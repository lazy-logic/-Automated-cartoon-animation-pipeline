...
import { CHARACTER_TEMPLATES, BACKGROUND_TEMPLATES, EXPRESSION_CONFIGS, SVG_BACKGROUNDS } from '@/lib/templates';
import { CHARACTER_SPRITES } from '@/lib/sprites';
import { isSpriteCharacter, getSpriteForCharacter, renderSpriteToCanvas } from '@/components/SpriteRenderer';
import type { CharacterInstance, Expression, Scene } from '@/lib/types';
