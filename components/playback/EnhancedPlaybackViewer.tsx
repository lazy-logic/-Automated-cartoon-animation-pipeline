...
import { EditableScene, EditableCharacter } from '../editors/InteractiveSceneEditor';
import { getAudioController, createNarrationDialogue, DialoguePlayer } from '@/lib/audio/audio-system';
import { MouthShape } from '@/lib/animation/keyframe-animation';
import AnimatedBackground from '../shared/AnimatedBackground';
import ParallaxBackground from '../shared/ParallaxBackground';
import SceneTransition, { TransitionType } from '../shared/SceneTransition';
import { getAmbientSoundController, AmbientSoundType } from '@/lib/audio/ambient-sounds';
import { 
  CameraState, 
...
import { 
  ...
  getSoundSynthesizer, 
  SoundEvent 
} from '@/lib/audio/auto-sound-generator';
import { 
  getMotionCurveForAction, 
  MOTION_PRESETS,
  calculateSquashStretch 
} from '@/lib/animation/animation-interpolation';
import {
  Layer,
  createLayer,
  getLayerFilterCSS,
