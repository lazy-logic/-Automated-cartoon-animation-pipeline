...
import AnimatedCharacterComponent from '../shared/AnimatedCharacter';
import { ANIMATED_CHARACTERS, getCharacterById } from '@/lib/utils/characters';
import { BACKGROUND_TEMPLATES } from '@/lib/utils/templates';
